...
export_code
  ...
  hlFitchWellFormed hlFitchVerified
  ...
  HL_AssumptionReused HL_SourceNotVerified
  ...
  hlEigenScopeViolations hlEigenScopeError hlBuildFitchItems
...
export_code
  ...
  hlFitchToLemmon hlFitchWellFormed hlFitchVerified

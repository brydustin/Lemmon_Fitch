...
theorems. \verb|hlClassifiedDerivationToFitch_conclusion| proves conclusion
preservation for every ancestor-classified tree, including a single premise.
General citation visibility and preservation of emitted rule applications
remain to be proved; these are the remaining counterparts of L2--L4.
\verb|hlDerivationOK_rename| now establishes fresh renaming for all exact

...
text \<open>The form above names the construction.  The paper's own form names only
  the two systems: whatever the Lemmon system proves from \<open>\<Gamma>\<close>, the Fitch system

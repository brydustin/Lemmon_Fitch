...
text \<open>The proposed positive half of Conjecture 28 --- that a laminar
  dependency family should guarantee a duplication-free image --- is therefore
  false for the standing definitions.  Example 12 has a laminar family, but no
  image at all, hence certainly no duplication-free one.\<close>
